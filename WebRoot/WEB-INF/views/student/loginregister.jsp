			...
			<div class="row">
				<div class="col-sm-8 col-sm-offset-2 text">
					...
					<div class="top-big-link">
						<a class="btn btn-link-1 launch-modal" href="#" data-modal-id="student-login">学生登录</a>
						<a class="btn btn-link-1 launch-modal" href="#" data-modal-id="student-register">学生注册</a>
						<a class="btn btn-link-1 launch-modal" href="#" data-modal-id="student-forget-pass">学生找回密码</a>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-header">
				...
				<h3 class="modal-title" id="modal-register-label">学生登录</h3>
				<p></p>
			</div>
			...
			<div class="modal-body">
				...
				<form role="form" id="login" action="${pageContext.request.contextPath }/student/loginCheck" method="post" class="registration-form">
					<div class="form-group">
						<label class="sr-only" for="sid_l">学号</label>
						<input type="text" name="sNum" onkeyup="this.value=this.value.replace(/[^0-9.]+/,'');" placeholder="学号" class="form-first-name form-control" required="required">
					</div>
					<div class="form-group">
						<label class="sr-only" for="spass_l">密码</label>
						<input type="password"  id="encryption" name="sPwd" required="required" placeholder="密码" class="form-last-name form-control" >
					</div>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-header">
				...
				<h3 class="modal-title" id="modal-register-label">学生注册</h3>
				<p></p>
			</div>
			
			<div class="modal-body">
				
				<form role="form"  id="register" action="${pageContext.request.contextPath }/student/register" method="post" class="registration-form">
					
					<div class="form-group">
						<label class="sr-only" for="sid_r">学号</label>
						<input id="rsNum" onkeyup="this.value=this.value.replace(/[^0-9.]+/,'');" type="text" name="sNum" placeholder="学号" required="" class="form-last-name form-control" >
					</div>
					<div class="form-group">
						<label class="sr-only" for="sname_r">姓名</label>
						<input id="rsName" type="text" name="sName" placeholder="姓名" required="" class="form-first-name form-control">
					</div>
					<div class="form-group">
						&nbsp;&emsp;<label  for="form-first-name">性别</label>&nbsp;&emsp;
						 <input type="radio" name="sGender" checked="checked" id="ssex_r" value="男" >男
						 &nbsp;&emsp;
						  <input type="radio" name="sGender" id="ssex_r" value="女">女
					</div>
					<div class="form-group">
						<label class="sr-only" for="spass_r1">密码</label>
						<input id="encryption1" type="password" name="sPwd" placeholder="密码" required="" class="form-last-name form-control">
					</div>
					<!-- <div class="form-group">
					...
					<div class="form-group">
						...
						<input id="emailAd" type="email" name="sEmail" placeholder="邮箱" required="" class="form-email form-control">
					</div>
					<div class="form-group">
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-header">
				...
				<h3 class="modal-title" id="modal-register-label">学生找回密码</h3>
				<p></p>
			</div>
			
			<div class="modal-body">
				
				<form role="form"  id="forgetPassword" action="${pageContext.request.contextPath }/student/forgetPassword" method="post" class="registration-form">
					
					<div class="form-group">
						<label class="sr-only" for="sid_r">学号</label>
						<input  id="fsNum" type="text" name="sNum" placeholder="学号" class="form-last-name form-control">
					</div>
					
					<div class="form-group">
						<label class="sr-only" for="scode_r">验证码</label>
						<input type="text" name="fEmailCode" id="femailcode" placeholder="验证码" class="form-control" ><br />
						<button  id="fsendemail" type="button"  class="btn" style="width: 200px; margin-left: 180px ;">获取验证码</button>
					</div>
					
					<div class="form-group">
						<label class="sr-only" for="sid_r">学号</label>
						<input id="fsPwd" type="password" name="sPwd" placeholder="新密码" class="form-last-name form-control">
					</div>
