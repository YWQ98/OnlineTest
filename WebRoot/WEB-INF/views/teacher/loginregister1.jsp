...
<div  id="small-dialog1" style="display: block;"><!-- class="mfp-hide" -->
	<div class="wthree-container">
		<div class="wthree-form bg">
			...
			<form action="${pageContext.request.contextPath }/teacher/loginCheck" id="login" method="post">
				<div class="w3-user">
					<span><i class="fa fa-user-o" aria-hidden="true"></i></span>
					<input type="text" name="tNum" onkeyup="this.value=this.value.replace(/[^0-9.]+/,'');" placeholder="学号" required="">
				</div>
				<div class="clear"></div>
				<div class="w3-psw">
					<span><i class="fa fa-key" aria-hidden="true"></i></span>
					<input type="password" id="encryption" name="tPwd" placeholder="密码" required="">
				</div>
				<div class="clear"></div>
				<div class="signin">
...
<div id="small-dialog2" style="display: none">
	<div class="wthree-container">
		<div class="wthree-form bg">	
			...
			<form id="register" action="${pageContext.request.contextPath }/teacher/register" method="post">
				<div >
					<input id="rsNum" onkeyup="this.value=this.value.replace(/[^0-9.]+/,'');" type="text" name="tNum" placeholder="学号" required="">
				</div>
				<div >
					<input id="rsName" type="text" name="tName" placeholder="姓名" required="">					
				</div>
				<div >
					<input id="encryption1" type="password" name="tPwd" placeholder="密码" required="">		
				</div><br/><br/><br/><br/>
				<div >
					<select name="tGender">
				...
				<div >
					<input id="emailAd" type="email" name="tEmail" placeholder="邮箱" required="">					
...
<div id="small-dialog3" style="display: none">
	<div class="wthree-container">
		<div class="wthree-form bg">	
			...
			<form id="forgetPassword" action="${pageContext.request.contextPath }/teacher/forgetPassword" method="post"><!-- "${pageContext.request.contextPath }/student/forgetPassword" -->
				<div >
					<input id="fsNum" type="text" name="tNum" placeholder="学号" required="">
				</div>
				<div class="clear"></div>
				...
				<div class="clear"></div>
				<div >
					<input id="fsPwd" type="password" name="tPwd" placeholder="新密码" required="">
				</div>
				<div class="clear"></div>
				<div class="signin">
